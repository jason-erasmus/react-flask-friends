export const USERS = [
  ...
  },
  {
    ...
    description: "I think the biggest thing that React Router tries to do is to make sure that the URL and the UI are always in sync with each other.",
  },
  {
    id: 3,
    name: "Kent C. Dodds",
    role: "Creator, Testing Library",
    description: "The more your tests resemble the way your software is used, the more confidence they can give you.",
  },
  {
    id: 4,
    name: "Michael Shilman",
    role: "Creator, Playroom",
    description: "With Playroom, you can create a zero-install code-oriented design environment that makes it easy to build and share components.",
  },
  {
    id: 5,
    name: "Cassidy Williams",
    role: "SWE 2",
    description: "I love the web platform and I want to make it as accessible as possible.",
  },
  {
    id: 6,
    name: "Chris Biscardi",
